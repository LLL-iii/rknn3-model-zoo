...
|:-----|:-----|:-----|:---:|:---:|:---:|
| Cygwin x86_64（Windows） | GCC 14，C++11 | 本机模拟 | 697/697 | 0.007 / 7.674 / **0.129** | 5.82 / 8.77 / **6.16** |
...
### 8.1 普通场景 vs 长上下文场景（分平台 avg 渲染耗时 ms）

| 平台 | 普通场景 avg | 长上下文 avg | longtext(200k) | long_hist(30 轮) | long_hist_long_input(50k/100k) |
|:-----|:---:|:---:|:---:|:---:|:---:|
| Linux x86_64 | 0.038 | 0.998 | 1.677 | 0.690 | 0.814 |
| Linux aarch64（RK3588） | 0.087 | 2.515 | 4.342 | 1.705 | 2.007 |
| Android arm64-v8a（RK3576） | 0.250 | 8.516 | 15.770 | 5.330 | 6.482 |

> 长上下文场景（200k 长文本 / 30 轮历史 / 长输入）比普通场景慢 20~30 倍（x86 0.04→1.0ms、aarch64 0.09→2.5ms、android 0.25→8.5ms），主要开销在逐 token 遍历长文本。普通场景均远低于 1ms 目标。

### 8.2 分模型 × 分平台（avg 渲染耗时 ms / 峰值内存 MB）

| 模型 | x86 耗时 | x86 内存 | aarch64 耗时 | aarch64 内存 | android 耗时 | android 内存 |
|:-----|:---:|:---:|:---:|:---:|:---:|:---:|
| FastVLM | 0.125 | 13.63 | 0.323 | 3.77 | 0.829 | 4.28 |
| GME-Qwen2-VL | 0.116 | 14.03 | 0.248 | 3.79 | 0.890 | 4.30 |
| HY_MT_1_5 | 0.098 | 14.10 | 0.253 | 4.04 | 0.755 | 4.36 |
| InternVLM | 0.112 | 14.10 | 0.269 | 3.80 | 0.903 | 4.29 |
| MiniCPM_V_4 | 0.132 | 14.10 | 0.347 | 3.45 | 1.101 | 4.34 |
| Qwen2_5 | 0.116 | 14.10 | 0.287 | 3.59 | 0.931 | 4.35 |
| Qwen2_5_Omni | 0.096 | 14.10 | 0.286 | 3.80 | 0.717 | 4.31 |
| Qwen2_5_VL | 0.104 | 14.10 | 0.286 | 3.80 | 0.802 | 4.30 |
| Qwen3 | 0.165 | 14.10 | 0.394 | 3.48 | 1.695 | 4.42 |
| Qwen3_5 | 0.196 | 14.10 | 0.427 | 3.88 | 1.842 | 4.41 |
| Qwen3_Embedding | 0.171 | 14.10 | 0.395 | 3.49 | 1.380 | 4.40 |
| Qwen3_Reranker | 0.099 | 14.10 | 0.259 | 3.76 | 0.677 | 4.27 |
| Qwen3_VL | 0.103 | 14.22 | 0.258 | 3.48 | 0.786 | 4.37 |
| Qwen3_VL_LoRA | 0.105 | 14.24 | 0.274 | 3.47 | 0.790 | 4.39 |
| SmolVLM | 0.130 | 14.24 | 0.345 | 3.43 | 0.988 | 4.30 |
| SmolVLM2 | 0.129 | 14.24 | 0.388 | 3.46 | 0.928 | 4.34 |
| gemma4 | 0.335 | 14.24 | 0.731 | 3.93 | 2.705 | 4.56 |
| glm_edge | 0.105 | 14.24 | 0.262 | 3.80 | 0.772 | 4.27 |

> 最慢为最复杂模板 gemma4（x86 0.335ms / aarch64 0.731ms / android 2.705ms）与 Qwen3_5/Qwen3 系列（大模板 + 分支多）。
