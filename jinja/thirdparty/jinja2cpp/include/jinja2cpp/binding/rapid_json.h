...
struct Reflector<rapidjson::GenericValue<Enc>>
{
    static Value CreateFromPtr(const rapidjson::GenericValue<Enc>* val)
    {
        ...
        {
            auto accessor = RapidJsonObjectAccessor<rapidjson::GenericValue<Enc>>(val);
            result = GenericMap([accessor]() { return &accessor; });
            break;
        }
        case rapidjson::kArrayType:
        {
            auto accessor = RapidJsonArrayAccessor<Enc>(val);
            result = GenericList([accessor]() { return &accessor; });
            break;
        }
...
struct Reflector<rapidjson::GenericDocument<Enc>>
{
    ...
    {
        auto accessor = RapidJsonObjectAccessor<rapidjson::GenericDocument<Enc>>(&val);
