...
struct Reflector<nlohmann::json>
{
    static Value Create(nlohmann::json val)
    {
        ...
        {
            auto accessor = NLohmannJsonObjectAccessor(std::move(val));
            result = GenericMap([accessor]() { return &accessor; });
            break;
        }
        case nlohmann::detail::value_t::array:
        {
            auto accessor = NLohmannJsonArrayAccessor(std::move(val));
    ...
    static Value CreateFromPtr(const nlohmann::json *val)
    {
        ...
        case nlohmann::detail::value_t::object:
        {
            auto accessor = NLohmannJsonObjectAccessor(val);
            result = GenericMap([accessor]() { return &accessor; });
            break;
        }
        case nlohmann::detail::value_t::array:
        {
            auto accessor = NLohmannJsonArrayAccessor(val);
            result = GenericList([accessor]() {return &accessor;});
            break;
        }
        case nlohmann::detail::value_t::string:
