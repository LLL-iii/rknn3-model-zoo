...
template<typename It1, typename It2>
auto MakeGenericList(It1&& it1, It2&& it2, std::input_iterator_tag) -> GenericList
{
    auto accessor = InputIteratorListAccessor<It1, It2>(std::forward<It1>(it1), std::forward<It2>(it2));
    return GenericList([accessor]() {return &accessor;});
}

template<typename It1, typename It2>
auto MakeGenericList(It1&& it1, It2&& it2, std::random_access_iterator_tag) -> GenericList
{
    auto accessor = RandomIteratorListAccessor<It1, It2>(std::forward<It1>(it1), std::forward<It2>(it2));
    return GenericList([accessor]() {return &accessor;});
}

template<typename It1, typename It2, typename Category>
auto MakeGenericList(It1&& it1, It2&& it2, Category) -> GenericList
{
    auto accessor = ForwardIteratorListAccessor<It1, It2>(std::forward<It1>(it1), std::forward<It2>(it2));
    return GenericList([accessor]() {return &accessor;});
}

auto MakeGeneratedList(ListGenerator&& fn) -> GenericList
{
    auto accessor = GeneratedListAccessor(std::move(fn));
    return GenericList([accessor]() {return &accessor;});
}
} // namespace lists_impl
