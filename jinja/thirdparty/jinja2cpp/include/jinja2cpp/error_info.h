...
public:
    ...
    auto GetErrorLocation() const -> const SourceLocation&
    {
        return m_errorData.srcLoc;
    }

    //! Return locations, related to the main error location
    auto GetRelatedLocations() const -> const std::vector<SourceLocation>&
    {
     ...
     */
    auto GetExtraParams() const -> const std::vector<Value>& { return m_errorData.extraParams; }
