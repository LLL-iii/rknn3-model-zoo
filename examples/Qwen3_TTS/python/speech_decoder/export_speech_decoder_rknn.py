...
ONNX_MODEL = '../../models/speech_decoder/speech_decoder.onnx'
RKNN_MODEL = '../../models/speech_decoder/speech_decoder.rknn'
...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description="Export Qwen3-TTS speech_decoder to RKNN model") 
