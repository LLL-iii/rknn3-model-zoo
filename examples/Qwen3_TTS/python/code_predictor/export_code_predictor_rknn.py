...
ONNX_MODEL = '../../models/code_predictor/code_predictor.onnx'
LLM_CONFIG = '../../models/code_predictor/code_predictor.config.pkl'
RKNN_MODEL = '../../models/code_predictor/code_predictor.rknn'
...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description="Export Qwen3-TTS code_predictor to RKNN model") 
    ...
    llm_config['attention_config'][0]['kvcache_buffer_len'] = 32
    ...
    dynamic_input = [
        [[1, 2, hidden_size], [1, 2], [1, 2], [1], [1]],
        [[1, 1, hidden_size], [1, 1], [1, 1], [1], [1]],
    ]
