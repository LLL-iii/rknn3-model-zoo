...
if __name__ == '__main__':
    ...
    parser.add_argument("--export_encoder_path", type=str, help="export audio encoder onnx model path", required=False, default="../../../models/encoder_online.onnx")
    ...
    x = torch.randn(1, 1, 128, 100, dtype=torch.float32)
    torch.onnx.export(
