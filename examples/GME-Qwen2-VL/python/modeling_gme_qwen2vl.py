...
class GmeQwen2VL(PreTrainedModel):
    ...
    def forward(
        ...
        **kwargs
        ...
        if num_logits_to_keep is not None:
            embeddings = hidden_states[:, num_logits_to_keep, :]
    ...
    def embed(self, texts: list[str], images: list[Image.Image], is_query=True, instruction=None, num_logits_to_keep=None, **kwargs):
        self.eval()
