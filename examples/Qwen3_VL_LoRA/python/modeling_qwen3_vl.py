...
class Qwen3VLTextModel(Qwen3VLPreTrainedModel):
    ...
    def forward(
        ...
        deepstack_visual_embeds0: Optional[torch.Tensor] = None,
        deepstack_visual_embeds1: Optional[torch.Tensor] = None,
        deepstack_visual_embeds2: Optional[torch.Tensor] = None,
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        for layer_idx, decoder_layer in enumerate(self.layers):
            ...
            if layer_idx == 0:
                hidden_states += deepstack_visual_embeds0
            if layer_idx == 1:
                hidden_states += deepstack_visual_embeds1
            if layer_idx == 2:
                hidden_states += deepstack_visual_embeds2
