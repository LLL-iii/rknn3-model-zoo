...
class MetaspacePreTokenizer : public PreTokenizer {
 ...
 private:
  std::string replacement_;  // UTF-8 string, e.g. "▁" or "Ġ"
  std::string prepend_scheme_; // "always", "never", "first"
  bool split_;
};
