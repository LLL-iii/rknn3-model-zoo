...
|:-----|--------:|--------:|---------------:|
| x86_64 | 981.6 | — | 101.9 |
| Linux aarch64（RK3588） | 2,914.4 | 24.4 | 34.3 |
| Android arm64-v8a（RK3576） | 4,944.0 | 29.4 | 20.2 |

**分模型纯编码耗时**（毫秒）：

| 模型 | x86_64 | RK3588 | RK3576 |
|:-----|------:|------:|------:|
| FastVLM | 48.4 | 133.6 | 600.2 |
| HY_MT_1_5 | 75.1 | 196.4 | 355.1 |
| Janus_Pro | 86.8 | 199.8 | 535.1 |
| SmolVLM | 155.1 | 417.0 | 860.1 |
| SmolVLM2 | 153.2 | 417.6 | 875.5 |
| MiniCPM_V_4 | 651.7 | 1,968.7 | 3,501.3 |
| gemma4 | 655.1 | 1,994.6 | 3,416.1 |
| glm_edge | 936.2 | 2,783.0 | 4,771.2 |
| Qwen3 | 981.6 | 2,914.4 | 4,944.0 |
| Qwen2_5 | 1,067.7 | 2,924.5 | 4,954.4 |
| **平均** | **741.8** | **2,191.9** | **3,817.0** |
